...
def fld_a(row, field, viewname, *args):
    fld_reverse(row, field, viewname, *args, a_link='A')
...
def fld_link(row, field, viewname, *args):
    fld_reverse(row, field, viewname, *args, a_link='LINK')
