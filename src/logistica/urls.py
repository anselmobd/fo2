...
urlpatterns = [
    ...
    url(r'^notafiscal_rel/$',
        logistica.views.NotafiscalRel.as_view(), name='notafiscal_rel'),
    url(r'^notafiscal_rel/(?P<dia>\d+)/(?P<mes>\d+)/(?P<ano>\d+)/$',
        logistica.views.NotafiscalRel.as_view(), name='notafiscal_rel__get'),

    url(r'^notafiscal_chave/(?P<chave>\d+)?/?$',
        logistica.views.NotafiscalChave.as_view(), name='notafiscal_chave'),

    url(r'^notafiscal_nf/(?P<nf>\d+)?/?$',
        logistica.views.notafiscal_nf, name='notafiscal_nf'),

    url(r'^notafiscal_embarcando/$',
        logistica.views.NotafiscalEmbarcando.as_view(), name='notafiscal_embarcando'),
    ...
    url(r'^entrada_nf/_sem_xml/$',
        logistica.views.EntradaNfSemXml.as_view(), name='entr_nf_sem_xml'),
