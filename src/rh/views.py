...
def aniversariantes(request, ano, mes):
    ...
    aniversariantes = [
        ...
        ['01/10', 'Terezinha Rozana Menezes Braga', 'Revisor de Qualidade'],
        ['03/10', 'Adriana Martins de Andrade', 'Supervisora'],
        ['03/10', 'Anselmo Blanco Dominguez', 'Gerente de TI'],
        ['05/10',
            'Leandro de Souza Bezerra', 'Operador de Maquina de Tecelagem'],
        ['06/10',
            'Victória Nascimento Gomes',
            'Aprendiz Aux. Operação de Logistica'],
        ['07/10', 'Lucas Lima Braga', 'Assist. de Produção'],
        ['07/10', 'Monique Carla Pereira Silva', 'Costureira'],
        ['08/10', 'Deivid Duarte Tavares Reis', 'Assist. de Produção'],
        ['10/10', 'Felipe dos Santos Maria', 'Assist. de Produção'],
        ['10/10', 'Joziane Rosa', 'Assist. de Produção'],
        ['11/10', 'Bianca Vasques Gonçalves', 'Assist Adm Industrial'],
        ['11/10', 'Thaiane Araujo Silva', 'Auxiliar Producao'],
        ['12/10',
            'Isaque Rodrigo dos Santos Miranda', 'Mecanico de Manutenção'],
        ['13/10', 'Luciane Beatriz Fabri', 'Costureira'],
        ['13/10', 'Vera Lucia Souza dos Santos', 'Costureira'],
        ['14/10', 'Shirley de Mello Nogueira', 'Auxiliar Contabil'],
        ['16/10',
            'Erivelto Alves de Melo', 'Operador de Maquina de Tecelagem'],
        ['17/10',
            'Stephanie Melo Chinaider de Oliveira', 'Assist. de Produção'],
        ['18/10', 'Ana Paula Pessoa de Melo', 'Faturista'],
        ['20/10', 'Valmir Lemos', 'Operador de Maquina de Tecelagem'],
        ['21/10',
            'Jonatas Rocha Ferreira', 'Operador de Maquina de Tecelagem'],
        ['21/10', 'Kelly Cristina Santos Souza', 'Assist. de Produção'],
        ['22/10', 'Deise Oliveira da Silva', 'Costureira'],
        ['22/10', 'Denise Bento dos Santos', 'Costureira'],
        ['22/10',
            'Rafaela Barroso de Carvalho',
            'Jovem Aprendiz Oper.De Sup. Tecnico Ti'],
        ['24/10',
            'Elisangela Cristiane de Jesus Santos', 'Assist. de Produção'],
        ['24/10', 'Sandra Regina Guimaraes dos Santos', 'Costureira'],
        ['26/10',
            'Vanessa da Silva de Brito Monteiro', 'Revisor de Qualidade'],
        ['28/10', 'Jeane Silva de Andrade', 'Auxiliar Producao'],
        ['28/10', 'Tatiana Pereira da Costa', 'Costureira'],
        ['29/10', 'Luiz Claudio da Silva Vianna', 'Lider de Pcp'],
        ['30/10', 'Deise Lucia Araujo de Oliveira', 'Costureira'],
        ['30/10', 'Liliane Soares Jose Maria', 'Conferente de Qualidade'],
    ]
